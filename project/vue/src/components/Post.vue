<template>
    <div class="post-container-main home-page">
      <div v-if="this.$route.name == 'homes'" class="post-header">
        <div v-if="this.$route.name == 'homes'" id="post-details-profile-picture-div">
            <img
        ...
        <h3 v-if="this.$route.name == 'homes'" class="username-post">
          <router-link
      ...
      <div class="post-info">
        <div class="reactions" v-if="this.$route.name == 'homes'">
        ...
        <p id="caption" v-if="this.$route.name == 'homes' && !isEdit">
        ...
        <div
          class="comments"
          v-if="this.$route.name == 'homes' && hasMoreThan1Comment"
        >
        ...
        <div class="submit-new-comment">
          <input
            class="comment-input"
            v-if="$store.state.token != '' && this.$route.name == 'homes'"
            type="text"
            v-model="filter"
    ...
    export default {
      ...
      methods: {
        ...
        addFavorite(post) {
          ...
          this.$store.commit("ADD_FAV_VIDEO",post.video_url)
        ...
        removeFavorite(post) {
          apiService.deleteFavorite(post.post_id).then((response) => {
            if (response.status == 200) {
              this.$store.commit("REMOVE_FAV_VIDEO", post.video_url)
    ...
    .post-container-main {
      ...
      box-shadow: 2px 4px 4px rgb(94, 94, 94);
